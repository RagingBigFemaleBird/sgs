...
namespace Sanguosha.Expansions.Test
{
    public class TestExpansion : Expansion
    {
        public TestExpansion()
        {
            ...
            CardSet.Add(new Card(SuitType.None, -1, new HeroCardHandler(new Hero("Test", true, Allegiance.Wei, 7, new BeiGe(), new TianDu(), new KongCheng(), new FangZhu(), new HuJia(), new RenDe(), new FanJian(), new QingNang(), new JiJiu(), new LiJian(), new JiZhi(), new KuRou(), new KanPo()))));
