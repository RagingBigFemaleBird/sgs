...
namespace Sanguosha.Expansions.Test
{
    public class TestExpansion : Expansion
    {
        public TestExpansion()
        {
            ...
            CardSet.Add(new Card(SuitType.None, -1, new HeroCardHandler(new Hero("Test", false, Allegiance.Wei, 7, new LuanWu(), new HongYan(), new JieYin(), new JiZhi(), new KanPo(), new TianDu(), new GuHuo(), new ZhiHeng(), new LeiJi(), new LieGong(), new ShenSu(), new TianXiang(), new HuJia(), new RenDe(), new FanJian()))));
