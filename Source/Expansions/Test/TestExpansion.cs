...
namespace Sanguosha.Expansions.Test
{
    public class TestExpansion : Expansion
    {
        public TestExpansion()
        {
            ...
            CardSet.Add(new Card(SuitType.None, -1, new HeroCardHandler(new Hero("Test", false, Allegiance.Wei, 7, new LuoYi(), new XiaoJi(), new WuSheng(), new KeJi(), new JiLei(), new QinYin(), new RenDe(), new GuHuo(), new LuanWu(), new KuRou(), new JiJiang()))));
