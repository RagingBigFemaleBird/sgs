...
namespace Sanguosha.Expansions.Basic.Skills
{
    ...
    public class GuiCai : TriggerSkill
    {
        public void OnJudgeBegin(Player player, GameEvent gameEvent, GameEventArgs eventArgs)
        {
            ...
            List<Card> cards;
            List<Player> players;
            if (Game.CurrentGame.UiProxies[player].AskForCardUsage(new CardUsagePrompt("GuiCai", eventArgs.Source, eventArgs.Card.Suit, eventArgs.Card.Rank), new GuiCaiVerifier(), out skill, out cards, out players))
            {
