...
namespace Hills
{
    public class HillsExpansion : Expansion
    {
        public HillsExpansion()
        {
            ...
            CardSet.Add(new Card(SuitType.None, -1, new HeroCardHandler(new Hero("CaiWenJi", true, Allegiance.Qun, 3, new BeiGe(), new DuanChang()))));
            CardSet.Add(new Card(SuitType.None, -1, new HeroCardHandler(new Hero("LiuShan", true, Allegiance.Shu, 3, new XiangLe(), new FangQuan()))));
